...
function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("adminToken", "mocked-jwt-token-12345");

    navigate("/dashboard");

    console.log("Logged in temporarily with:", { email, password });
  };
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 bg-[#0F172A]">
        <div className="w-full max-w-md space-y-8 bg-[#1E293B] p-8 rounded-2xl shadow-xl border border-slate-700/50">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-semibold py-3 px-4 rounded-xl shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 transition transform active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-blue-500/50"
            >
              Sign In to System
            </button>
          </form>
